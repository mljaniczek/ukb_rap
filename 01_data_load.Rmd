...
eventdate_key <- colnames(fo%>% select(-c(Date.of.attending.assessment.centre...Instance.0, Sample.Measured.Date.and.Time...Instance.0)))[str_detect(colnames(fo%>% select(-c(Date.of.attending.assessment.centre...Instance.0, Sample.Measured.Date.and.Time...Instance.0))), "Date")]
